  ...
  render() {
    return (
      <div className="container">
        ...
        <div className="scorePlayer">Player 1: {this.state.scorePlayer1}</div>
        <div className="scorePlayer">Player 2: {this.state.scorePlayer2}</div>
        ...
        <div className="box-container">
          {this.state.boxes.map((box, key) => (
            <div className="box" id={key} onClick={this.handleClick}>
              {box}
            </div>
          ))}
        </div>
        ...
        <button className="reset" id="reset" onClick={this.reset}>
          Reset Board
        </button>
        <button className="reset" id="reset" onClick={this.startAgain}>
          Reset Game
        </button>
      </div>
    );
